...
public class ImageEditViewOverlay extends View {
    ...
    public static final int DEFAULT_FREESTYLE_CROP_MODE = FREESTYLE_CROP_MODE_ENABLE;
    ...
    private boolean showCropRect;
    private boolean mShouldSetupCropBounds;

    {
        mTouchPointThreshold = getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_default_crop_rect_corner_touch_threshold);
        mCropRectMinSize = getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_default_crop_rect_min_size);
        mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_default_crop_rect_corner_touch_area_line_length);
    }

    public ImageEditViewOverlay(Context context) {
        this(context, null);
    }

    public ImageEditViewOverlay(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageEditViewOverlay(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean isShowCropRect() {
        return showCropRect;
    }

    public void setShowCropRect(boolean showCropRect) {
        this.showCropRect = showCropRect;
        invalidate();
    }
    ...
    public void setFreestyleCropMode(@OverlayView.FreestyleMode int mFreestyleCropMode) {
    ...
    protected void init() {
        ...
        mCircleDimmedLayer = DEFAULT_CIRCLE_DIMMED_LAYER;
        mDimmedColor = getResources().getColor(R.color.colorDefaultImageEditDimmed, null);
...
//        }
    ...
    private void initCropFrameStyle() {
        int cropFrameStrokeSize = getResources().getDimensionPixelSize(R.dimen.widthDefaultCropFrameStock);
        int cropFrameColor = getResources().getColor(R.color.colorDefaultCropFrame);
    ...
    private void initCropGridStyle() {
        int cropGridStrokeSize = getResources().getDimensionPixelSize(R.dimen.widthDefaultCropGridStck);
        int cropGridColor = getResources().getColor(R.color.colorDefaultCropGrid);
