...
package com.uc.android.ex.camera2.portability;
...
public abstract class CameraAgent {
    ...
    private static final String TAG = "CamAgnt";
     ...
     * in the framework, {@link Camera.ErrorCallback}, which
    ...
    public static interface CameraOpenCallback {
        ...
        /**
         * Callback when {@link com.uc.android.camera.CameraDisabledException} is
         * caught.
         *
        ...
        /**
         * Callback when {@link com.uc.android.camera.CameraHardwareException} is
         * caught.
         *
     ...
     * onCameraOpened(com.uc.android.camera.cameradevice.CameraAgent.CameraProxy)}.
     *
    ...
    public abstract static class CameraProxy {
         ...
         * .CameraOpenCallback#onCameraOpened(com.uc.android.camera.cameradevice.CameraAgent
         * .CameraProxy)}.
        ...
        /**
         * Blocks until a {@link SurfaceTexture} has been set
         * for preview.
         *
         * <p>Note that, once this operation has been performed, it is no longer
         * possible to change the preview or photo sizes in the
