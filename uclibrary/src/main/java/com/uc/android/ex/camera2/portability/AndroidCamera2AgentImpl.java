...
import com.uc.android.ex.camera2.utils.Camera2RequestSettingsSet;
...
class AndroidCamera2AgentImpl extends CameraAgent {
    private static final String TAG = "AndCam2AgntImp";
    ...
    /**
     * Transformation between integral camera indices and the {@link String} indices used
    ...
    private class Camera2Handler extends com.uc.android.ex.camera2.portability.HistoryHandler {
        // Caller-provided when leaving CAMERA_UNOPENED state:
        private com.uc.android.ex.camera2.portability.CameraAgent.CameraOpenCallback mOpenCallback;
