...
import com.uc.android.camera.CaptureModuleUtil;
import com.uc.android.camera.exif.ExifInterface;
import com.uc.android.camera.exif.ExifTag;
import com.uc.android.camera.exif.Rational;
import com.uc.android.camera.one.AbstractOneCamera;
import com.uc.android.camera.one.CameraDirectionProvider;
import com.uc.android.camera.one.OneCamera;
import com.uc.android.camera.one.OneCamera.PhotoCaptureParameters.Flash;
import com.uc.android.camera.one.Settings3A;
import com.uc.android.camera.one.v2.ImageCaptureManager.ImageCaptureListener;
import com.uc.android.camera.one.v2.ImageCaptureManager.MetadataChangeListener;
import com.uc.android.camera.one.v2.camera2proxy.AndroidCaptureResultProxy;
import com.uc.android.camera.one.v2.camera2proxy.AndroidImageProxy;
import com.uc.android.camera.one.v2.camera2proxy.CaptureResultProxy;
import com.uc.android.camera.processing.imagebackend.TaskImageContainer;
import com.uc.android.camera.session.CaptureSession;
import com.uc.android.camera.ui.focus.LensRangeCalculator;
import com.uc.android.camera.ui.motion.LinearScale;
import com.uc.android.camera.util.CameraUtil;
import com.uc.android.camera.util.ExifUtil;
import com.uc.android.camera.util.JpegUtilNative;
import com.uc.android.camera.util.ListenerCombiner;
...
public class OneCameraZslImpl extends AbstractOneCamera {
    private static final String TAG = "OneCameraZslImpl2";
    ...
    /**
     * @see com.uc.android.camera.one.OneCamera#triggerFocusAndMeterAtPoint(float,
     *      float)
     */
    @Override
