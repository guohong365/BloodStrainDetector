...
import com.uc.android.camera.util.ConcurrentSharedRingBuffer;
import com.uc.android.camera.util.ConcurrentSharedRingBuffer.PinStateListener;
import com.uc.android.camera.util.ConcurrentSharedRingBuffer.Selector;
import com.uc.android.camera.util.ConcurrentSharedRingBuffer.SwapTask;
import com.uc.android.camera.util.Task;
 ...
 * {@link CameraCaptureSession.CaptureListener} to
...
public class ImageCaptureManager extends CameraCaptureSession.CaptureCallback implements
    ...
    private static final String TAG = "ZSLImageListener";
    ...
    private final Map<Key<?>, Pair<Long, Object>>
            mMetadata = new ConcurrentHashMap<Key<?>, Pair<Long, Object>>();
    ...
    ImageCaptureManager(int maxImages, Handler listenerHandler,
        ...
        mCapturedImageBuffer = new ConcurrentSharedRingBuffer<CapturedImage>(
                maxImages - 2);
