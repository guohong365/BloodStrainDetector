...
package com.uc.android.camera.one.v2;
...
import com.uc.android.camera.async.MainThread;
import com.uc.android.camera.async.Observable;
import com.uc.android.camera.async.Observables;
import com.uc.android.camera.async.Updatable;
import com.uc.android.camera.burst.BurstFacade;
...
import com.uc.android.camera.one.v2.camera2proxy.AndroidImageReaderProxy;
import com.uc.android.camera.one.v2.camera2proxy.CameraCaptureSessionProxy;
import com.uc.android.camera.one.v2.camera2proxy.CameraDeviceProxy;
import com.uc.android.camera.one.v2.camera2proxy.CameraDeviceRequestBuilderFactory;
import com.uc.android.camera.one.v2.camera2proxy.ImageReaderProxy;
import com.uc.android.camera.one.v2.camera2proxy.TotalCaptureResultProxy;
import com.uc.android.camera.one.v2.commands.BasicPreviewCommandFactory;
import com.uc.android.camera.one.v2.commands.CameraCommandExecutor;
import com.uc.android.camera.one.v2.common.BasicCameraFactory;
import com.uc.android.camera.one.v2.common.SimpleCaptureStream;
import com.uc.android.camera.one.v2.core.FrameServer;
import com.uc.android.camera.one.v2.core.FrameServerFactory;
import com.uc.android.camera.one.v2.core.RequestBuilder;
import com.uc.android.camera.one.v2.core.RequestTemplate;
import com.uc.android.camera.one.v2.core.ResponseListeners;
import com.uc.android.camera.one.v2.errorhandling.FramerateJankDetector;
import com.uc.android.camera.one.v2.imagesaver.ImageSaver;
import com.uc.android.camera.one.v2.initialization.CameraStarter;
import com.uc.android.camera.one.v2.initialization.InitializedOneCameraFactory;
import com.uc.android.camera.one.v2.photo.ImageRotationCalculator;
import com.uc.android.camera.one.v2.photo.LegacyPictureTakerFactory;
import com.uc.android.camera.one.v2.photo.PictureTaker;
import com.uc.android.camera.one.v2.photo.PictureTakerFactory;
import com.uc.android.camera.one.v2.sharedimagereader.ManagedImageReader;
import com.uc.android.camera.one.v2.sharedimagereader.SharedImageReaderFactory;
import com.uc.android.camera.util.AndroidContext;
import com.uc.android.camera.util.GservicesHelper;
import com.uc.android.camera.util.Provider;
        ...
        CameraStarter cameraStarter = new CameraStarter() {
            ...
            public CameraStarter.CameraControls startCamera(Lifetime cameraLifetime,
                ...
                if (supportLevel == OneCameraFeatureConfig.CaptureSupportLevel.LEGACY_JPEG) {
                    ...
                    pictureTaker = PictureTakerFactory.create(mainExecutor,
