...
package com.uc.android.camera.session;
...
public class CaptureSessionImpl implements CaptureSession {
    private static final String TAG = "CaptureSessionImpl";
    ...
    @Override
    public synchronized void startEmpty(@Nullable CaptureSession.ImageLifecycleListener listener,
    ...
    @Override
    public synchronized void startSession(@Nullable CaptureSession.ImageLifecycleListener listener,
