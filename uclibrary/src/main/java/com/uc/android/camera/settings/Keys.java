...
public class Keys {
    ...
    public static Ruler.RulerStyle getRulerStyle(SettingsManager settingsManager){
        int style= settingsManager.getInteger(SettingsManager.SCOPE_GLOBAL, KEY_CAMERA_RULER_STYLE);
        Ruler.RulerStyle rulerStyle= Ruler.RulerStyle.None;
        switch (style){
            case 0:
                break;
            case 1:
                rulerStyle= Ruler.RulerStyle.Brief;
                break;
            case 2:
                rulerStyle= Ruler.RulerStyle.Detail;
                break;
        }
        return rulerStyle;
    }
