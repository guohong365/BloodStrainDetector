...
public class DisableCameraReceiver extends BroadcastReceiver {
    private static final String TAG = "DisableCamRcver";
    private static final boolean CHECK_BACK_CAMERA_ONLY = true;
    private static final String ACTIVITIES[] = {
        "com.uc.android.camera.CameraLauncher",
    };
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        disableComponent(context, "com.uc.android.camera.DisableCameraReceiver");
    }
