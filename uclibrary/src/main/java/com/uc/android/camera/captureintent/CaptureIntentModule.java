...
import com.uc.android.camera.burst.BurstFacadeFactory;
import com.uc.android.camera.captureintent.event.EventClickOnCameraKey;
import com.uc.android.camera.captureintent.event.EventOnSurfaceTextureAvailable;
import com.uc.android.camera.captureintent.event.EventOnSurfaceTextureDestroyed;
...
import com.uc.android.camera.captureintent.event.EventResume;
...
import com.uc.android.camera.captureintent.resource.ResourceConstructedImpl;
import com.uc.android.camera.captureintent.state.StateBackground;
import com.uc.android.camera.captureintent.stateful.State;
import com.uc.android.camera.captureintent.stateful.StateMachine;
import com.uc.android.camera.captureintent.stateful.StateMachineImpl;
...
public class CaptureIntentModule extends CameraModule {
    private static final String TAG = "CapIntModule";
    ...
    public HardwareSpec getHardwareSpec() {
         ...
         * {@link com.uc.android.camera.captureintent.state.StateOpeningCamera}
