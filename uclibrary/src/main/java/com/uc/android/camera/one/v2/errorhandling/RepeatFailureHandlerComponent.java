...
public final class RepeatFailureHandlerComponent {
    ...
    public static RepeatFailureHandlerComponent create(
                                                       FatalErrorHandler fatalErrorHandler, CameraCaptureSessionProxy captureSession,
                                                       CameraCommandExecutor commandExecutor, Runnable previewStarter, int consecutiveFailureThreshold) {
        FastCameraReset fastCameraReset = new FastCameraReset(captureSession,
                commandExecutor, previewStarter);
        FatalErrorDialogFailureHandler fatalErrorDialog = new FatalErrorDialogFailureHandler
                (fatalErrorHandler);

        RecoverySuccessCallback recoverySuccessCallback = new RecoverySuccessCallback();
