...
/**
 * The {@link com.uc.android.camera.one.OneCameraOpener} implementation on top of Camera2 API.
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP)
public class Camera2OneCameraOpenerImpl implements OneCameraOpener {
    private static final String TAG = "OneCamera1Opnr";
    ...
    /**
     * Instantiates a new {@link com.uc.android.camera.one.OneCameraOpener} for Camera2 API.
     *
