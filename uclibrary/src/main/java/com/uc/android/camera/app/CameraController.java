...
/**
 * A class which implements {@link com.uc.android.camera.app.CameraProvider} used
 * by {@link CameraActivity}.
...
public class CameraController implements CameraAgent.CameraOpenCallback, CameraProvider {
     ...
     * Constructor.
     *
     * @param context The {@link Context} used to check if the
     *                camera is disabled.
     * @param handler The {@link Handler} to post the camera
     *                callbacks to.
