...
public abstract class CameraSettings {
    private static final String TAG = "CamSet";
     ...
     *              com.uc.android.camera.cameradevice.CameraCapabilities#getMaxZoomRatio()}.
     * @throws UnsupportedOperationException if the ratio is not
     *         supported.
     */
     ...
     * @throws UnsupportedOperationException if it's not supported.
     */
