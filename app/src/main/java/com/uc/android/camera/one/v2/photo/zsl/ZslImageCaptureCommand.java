...
package com.uc.android.camera.one.v2.photo.zsl;
...
import com.uc.android.camera.one.v2.core.ResourceAcquisitionFailedException;
import com.uc.android.camera.one.v2.imagesaver.ImageSaver;
import com.uc.android.camera.one.v2.photo.ImageCaptureCommand;
...
public class ZslImageCaptureCommand implements ImageCaptureCommand {
    private final String TAG="ZSLImageCaptureCmd";
    ...
    public void run(Updatable<Void> imageExposeCallback, ImageSaver imageSaver)
        ...
        try {
            ...
            if (image != null) {
                ...
                Log.i(TAG,"No ZSL image available, using fallback: " + mFallbackCommand);
