...
package com.uc.android.camera.one.v2.sharedimagereader.imagedistributor;

import android.util.Log;

import com.uc.android.camera.async.BufferQueue;
import com.uc.android.camera.async.BufferQueueController;
...
class ImageDistributorImpl implements ImageDistributor {
    ...
    private final String TAG="ImgDistributorImpl";
    ...
    public void distributeImage(ImageProxy image) {
        ...
        for (DispatchRecord dispatchRecord : recordsToProcess) {
            ...
            while (requestedImageTimestamp != null && requestedImageTimestamp < timestamp) {
                ...
                Log.e(TAG,String.format("Image (%d) expected, but never received!  Instead, " +
