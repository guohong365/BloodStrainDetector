...
package com.uc.android.camera.one.v2.photo;

import android.hardware.camera2.CameraDevice;

import com.uc.android.camera.async.BufferQueue;
import com.uc.android.camera.async.MainThread;
import com.uc.android.camera.one.OneCamera;
import com.uc.android.camera.one.v2.camera2proxy.ImageProxy;
...
import com.uc.android.camera.one.v2.core.ResponseManager;
import com.uc.android.camera.one.v2.imagesaver.ImageSaver;
import com.uc.android.camera.one.v2.photo.zsl.AcceptableZslImageFilter;
import com.uc.android.camera.one.v2.photo.zsl.AutoFlashZslImageFilter;
import com.uc.android.camera.one.v2.photo.zsl.ZslImageCaptureCommand;
import com.uc.android.camera.one.v2.sharedimagereader.ManagedImageReader;
import com.uc.android.camera.one.v2.sharedimagereader.metadatasynchronizer.MetadataPool;
import com.google.common.base.Supplier;

import java.util.Arrays;

import static com.uc.android.camera.one.v2.core.ResponseListeners.forPartialMetadata;
...
public class ZslPictureTakerFactory {
    ...
    public static ZslPictureTakerFactory create(
        ...
        AutoFlashZslImageFilter autoFlashZslImageFilter = AutoFlashZslImageFilter.create(true);
