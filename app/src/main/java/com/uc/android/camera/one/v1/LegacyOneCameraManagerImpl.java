...
package com.uc.android.camera.one.v1;
...
/**
 * The {@link com.uc.android.camera.one.OneCameraManager} implementation on top of the Camera API 1.
 */
public class LegacyOneCameraManagerImpl implements OneCameraManager {
    private static final String TAG = "LegacyHM";
    ...
    /**
     * Instantiates a new {@link com.uc.android.camera.one.OneCameraManager} for Camera1 API.
     */
