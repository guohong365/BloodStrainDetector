...
import com.uc.android.camera.SoundPlayer;
...
import com.uc.android.camera.one.v2.camera2proxy.AndroidCameraDeviceProxy;
import com.uc.android.camera.one.v2.common.PictureSizeCalculator;
import com.uc.android.camera.one.v2.imagesaver.ImageSaver;
import com.uc.android.camera.one.v2.imagesaver.JpegImageBackendImageSaver;
import com.uc.android.camera.one.v2.imagesaver.YuvImageBackendImageSaver;
import com.uc.android.camera.one.v2.photo.ImageRotationCalculator;
import com.uc.android.camera.processing.ProcessingServiceManager;
import com.uc.android.camera.processing.imagebackend.ImageBackend;

public class OneCameraCreator {
    private static String TAG = "OneCamCreator";
