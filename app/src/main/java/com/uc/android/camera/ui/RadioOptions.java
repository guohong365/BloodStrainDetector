...
/**
 * A LienearLayout for a set of {@link View}s,
 * one of which can be selected at any time.
 */
public class RadioOptions extends TopRightWeightedLayout {
    /**
     * Listener for responding to {@link View} click events.
     */
    public interface OnOptionClickListener {
        /**
         * Override to respond to  {@link View} click events.
    ...
    /**
     * Update each child {@link View}'s {@link OnClickListener}.
    ...
    /**
     * Sets a child {@link View} as selected by tag.
     * @param tag Tag that identifies a child {@link View}. No effect if view not found.
     */
    ...
    /**
     * Sets a child {@link View} as selected by id.
     * @param id Resource ID  that identifies a child {@link View}. No effect if view not found.
     */
