...
package com.uc.android.camera.burst;
...
import com.uc.android.camera.burst.BurstController.ImageStreamProperties;

import com.uc.android.camera.one.OneCamera.Facing;
import com.uc.android.camera.session.CaptureSession;
import com.uc.android.camera.session.StackSaver;
 ...
 * burst items to a {@link com.uc.android.camera.processing.ProcessingTask} and
 * change API to use {@link com.uc.android.camera.processing.ProcessingService}.
...
class BurstFacadeImpl implements BurstFacade {
    ...
    private static final String TAG = "BurstFacadeImpl";
