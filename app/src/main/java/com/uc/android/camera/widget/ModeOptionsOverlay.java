...
package com.uc.android.camera.widget;
...
public class ModeOptionsOverlay extends FrameLayout
    ...
    public void onFinishInflate() {
        ...
        mModeOptionsToggle.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void checkOrientation(int orientation) {
        ...
        LayoutParams modeOptionsParams
            = (LayoutParams) mModeOptions.getLayoutParams();
        LayoutParams modeOptionsToggleParams
            = (LayoutParams) mModeOptionsToggle.getLayoutParams();
