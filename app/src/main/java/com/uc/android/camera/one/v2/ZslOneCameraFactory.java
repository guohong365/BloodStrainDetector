...
import com.uc.android.camera.burst.BurstTaker;
import com.uc.android.camera.burst.BurstTakerImpl;
...
import com.uc.android.camera.one.v2.commands.ZslPreviewCommandFactory;
...
import com.uc.android.camera.one.v2.errorhandling.RepeatFailureHandlerComponent;
...
import com.uc.android.camera.one.v2.photo.ZslPictureTakerFactory;
import com.uc.android.camera.one.v2.sharedimagereader.ZslSharedImageReaderFactory;
...
public class ZslOneCameraFactory implements OneCameraFactory {
    private static String TAG = "ZslOneCamFactory";
