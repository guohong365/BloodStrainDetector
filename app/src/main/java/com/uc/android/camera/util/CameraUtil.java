...
package com.uc.android.camera.util;
...
import com.uc.android.camera.CameraDisabledException;
...
public class CameraUtil {
    ...
    public static final String REVIEW_ACTION = "com.uc.android.camera.action.REVIEW";
     ...
     * picture-taking mode.
     */
    public static final String ACTION_CAMERA_STARTED = "com.uc.android.camera.action.CAMERA_STARTED";
    /**
     * Broadcast Action: The camera application is no longer in active
     * picture-taking mode.
     */
    public static final String ACTION_CAMERA_STOPPED = "com.uc.android.camera.action.CAMERA_STOPPED";
    /**
    ...
    public static final String ACTION_CAMERA_SHUTTER_CLICK =
            "com.uc.android.camera.action.SHUTTER_CLICK";
    ...
    public static void broadcastNewPicture(Context context, Uri uri) {
        ...
        // Keep compatibility
        context.sendBroadcast(new Intent("com.uc.android.camera.NEW_PICTURE", uri));
    }
     ...
     * @return A {@link String} of all the output with newline between
     *         each.
     */
