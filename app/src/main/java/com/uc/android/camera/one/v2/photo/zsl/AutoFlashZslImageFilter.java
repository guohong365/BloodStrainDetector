...
import com.uc.android.camera.one.v2.camera2proxy.CaptureRequestProxy;
...
public final class AutoFlashZslImageFilter implements Predicate<TotalCaptureResultProxy>,
    ...
    private final String TAG="AutoFlashZslImgFltr";
    ...
    private AutoFlashZslImageFilter(AcceptableZslImageFilter defaultFilter) {
    ...
    public static AutoFlashZslImageFilter create(boolean requireAFConvergence) {
        return new AutoFlashZslImageFilter(new AcceptableZslImageFilter(requireAFConvergence, /* aeConvergence */true));
    }
