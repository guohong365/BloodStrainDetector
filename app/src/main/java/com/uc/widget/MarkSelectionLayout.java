...
public class MarkSelectionLayout extends LinearLayout implements OptionChangedNotifier{
    ...
    protected void buildMarks(){
        ...
        markItems.add(new MarkItem(MARK_SQUARE, R.drawable.ic_mark_square));
        markItems.add(new MarkItem(MARK_CIRCLE, R.drawable.ic_mark_circle));
        markItems.add(new MarkItem(MARK_TRIANGLE, R.drawable.ic_mark_triangle));
        markItems.add(new MarkItem(MARK_ARROW_LEFT, R.drawable.ic_mark_arrow_left));
        markItems.add(new MarkItem(MARK_ARROW_RIGHT, R.drawable.ic_mark_arrow_right));
        markItems.add(new MarkItem(MARK_ARROW_DOWN, R.drawable.ic_mark_arrow_down));
        markItems.add(new MarkItem(MARK_ARROW_UP, R.drawable.ic_mark_arrow_up));
