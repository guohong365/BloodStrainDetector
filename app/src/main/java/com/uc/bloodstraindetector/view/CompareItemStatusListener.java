 ...
 */
public interface CompareItemStatusListener extends TextureView.SurfaceTextureListener {
    /**
     * The preview status listener needs to provide an
     * {@link GestureDetector.OnGestureListener} in order to listen
    ...
    /**
     * An {@link View.OnTouchListener} can be provided in addition to
     * or instead of a {@link GestureDetector.OnGestureListener}
     * for listening to touch events on the preview.  The listener is called whenever
     * there is a touch event on the {@link com.uc.android.camera.ui.PreviewOverlay}.
     */
     ...
     */
    public interface CompareItemAreaChangedListener {
     ...
     */
    public interface CompareItemAspectRatioChangedListener {
        public void onItemAspectRatioChanged(float aspectRatio);
    }
}
